...
const int32_t MasternodePaymentsStartBlock = 18000; // not true, but it's ok as long as it's less then nMasternodePaymentsIncreaseBlock
const int32_t MasternodePaymentsIncreaseBlock = 18000; // actual historical value
...
const int32_t BudgetPaymentsStartBlock = 18008; // actual historical value
...
const int32_t SuperblockStartBlock = 18020; // The block at which 12.1 goes live (end of final 12.0 budget cycle)
